...
$text["whoIs_person1_text"]="Klaus started to develop software for microcomputers in 1979, when he was a pioneer in graphics s
oftware and software to control electronic instruments. In 1982, he founded Palette Imagem Eletrônica, one of the first graphical production companies in Brazil.<br>In the same time span, he started working with special effects using computer graphics for cinema and advertising in partnership with the production company Ilimitada Ltda.<br>He was the technology director for several advertising agencies, such as Z+G Gray, Rapp Digital, Euro RSCG, amongst others and he has been working with e-commerce developing cloud solutions aiming at high availability and scalability.";
$text["whoIs_person2_title"]="Mauro Letizia";
$text["whoIs_person2_text"]="Mauro Letizia graduated in Communications at ESPM in 1986 and has 32 years of experience in digital communication and has always worked in the creative and art direction fields.<br>In 1987 he founded Oficina Algorítmica, one of the main digital marketing agencies in Brazil, which was acquired by Rapp Collins in 2000, a marketing relationship agency from Omnicom Group ,where he was the Vice-President of Digital Communication for 16 years.<br>In the course of his career he has worked for big name brands such as Nestlé, General Motors, Avon, Accor, Warner Music, Bayer, Banco Itaú, Citroën, Nokia, Phillips, Vivo, Pepsi, Pfizer, Nycomed, Roche, HP, Volkswagen, Mastercard, Shell, BMW, Mini e P&G , among others.<br>He has won some of the most important digital awards, including Gramado, ABANET, ABEMD, iBest, DMA, Amauta, LIAA and Cannes.";
$text["contact_title"]="contact";
$text["contact_subtitle"]="Want to contact us?";
$text["contact_information"]='Call us at <a class="mobile" href="tel:+551194470.888">+55 11 9 4470.8884</a> <span class="desktop">+55 11 9 4470.8884</span> or send a message through the form bellow:';
...
$text["dialogValidate_name_fail"]="Please use only letters and spaces in your name.";
$text["dialogMising_name"]="Fill in your name before sending the message.";
$text["dialogMising_email"]="Fill in your e-mail before sending the message.";
$text["dialogMising_subject"]="Fill in the subject before sending the message.";
$text["dialogMising_message"]="Write the message before sending it.";
?>